...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-03-2019 a las 22:38:05
...
CREATE TABLE `profesor` (
  ...
  `Ap_P` varchar(100) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `Ap_M` varchar(100) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `Usuario` varchar(250) COLLATE utf8mb4_spanish2_ci NOT NULL,
...
--
ALTER TABLE `profesor`
  ADD CONSTRAINT `fk_prof_dep` FOREIGN KEY (`id_depto`) REFERENCES `departamento` (`id_depto`);
COMMIT;
