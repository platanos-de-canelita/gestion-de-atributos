...
function getMateria(carrera){//---------GET MATERIA(Carrera) otro método
  ...
  $("#materiaFiltroProf").html("");
  $("#materiaFiltroProf").append("<option disabled selected>Selecciona una materia</option>");
  console.log(carrera);
  $.ajax({
    type: 'POST',
    url: '../function/getDataAtribMat.php',
...
function getAllatrib_mate(){
  ...
  $("#prfoesor_materia").append("<option disabled selected>Selecciona un profesor</option>");
  getCarreras();
//-------------------------------------------------------------------------
